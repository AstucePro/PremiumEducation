			...
			<form:form method="POST" modelAttribute="userForm" class="form-signin">
				<fieldset class="form-horizontal">
					...
					<spring:bind path="recruiter.cellphone">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label class="col-sm-5">Téléphone personnel*:</label>
							<div class="col-sm-7 input-group">
				                <form:input type="text" path="recruiter.cellphone" class="form-control" placeholder="Téléphone personnel"></form:input>
					...
					<spring:bind path="recruiter.company_number">
						<div class="form-group ${status.error ? 'has-error' : ''}">
							<label class="col-sm-5">Téléphone entreprise *:</label>
							<div class="col-sm-7 input-group">
				                <form:input type="text" path="recruiter.company_number" class="form-control" placeholder="Téléphone entreprise"></form:input>
